...
def get_cmd_args():
    ...
    if os.path.basename(sys.argv[0]) == 'flaskerizer' or os.path.basename(sys.argv[0]) == '__main__.py':
        ...
        parser.add_argument('--TLP', type=str, required=True, dest='top_level_path',
                            help='Full path of the top level folder of the Bootstrap template')

        parser.add_argument('--TP', type=str, required=True, dest='templates_path',
        ...
        parser.add_argument('--NL', dest='large_app_structure', action='store_false',
        ...
        parser.add_argument('--TLP', type=str, default=os.path.dirname(example.__file__), dest='top_level_path')

        parser.add_argument('--TP', type=str, default=os.path.dirname(example.__file__), dest='templates_path')
