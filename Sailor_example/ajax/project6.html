...
<div class="cbp-slider">
	<ul class="cbp-slider-wrap">
		<li class="cbp-slider-item">
			<iframe width="1024" height="600" src="//www.youtube.com/embed/4AivEQmfPpk" frameborder="0" allowfullscreen></iframe>
		</li>
		<li class="cbp-slider-item">
			<iframe width="1024" height="600" src="//www.youtube.com/embed/T6DJcgm3wNY" frameborder="0" allowfullscreen></iframe>
		</li>
		<li class="cbp-slider-item">
			<iframe width="1024" height="600" src="//www.youtube.com/embed/fnaojlfdUbs" frameborder="0" allowfullscreen></iframe>
		</li>
	</ul>
</div>
	...
	<div class="cbp-l-project-related">
		...
		<ul class="cbp-l-project-related-wrap">
			<li class="cbp-l-project-related-item">
				<a href="ajax/project5.html" class="cbp-singlePage cbp-l-project-related-link">
					<img src="img/works/5.jpg" alt="" width="100%">
			...
			<li class="cbp-l-project-related-item">
				<a href="ajax/project7.html" class="cbp-singlePage cbp-l-project-related-link">
					<img src="img/works/7.jpg" alt="" width="100%">
					<div class="cbp-l-project-related-title">Seemple* Music for iPad</div>
				</a>
			</li>
			<li class="cbp-l-project-related-item">
				<a href="ajax/project8.html" class="cbp-singlePage cbp-l-project-related-link">
					<img src="img/works/8.jpg" alt="" width="100%">
