...
<div class="cbp-slider" style="max-width: 800px">
	<ul class="cbp-slider-wrap">
		<li class="cbp-slider-item">
			<img src="img/works/9big.jpg" alt="" class="cbp-l-project-img">
		</li>
		<li class="cbp-slider-item">
			<img src="img/works/9big-1.jpg" alt="" class="cbp-l-project-img">
		</li>
		<li class="cbp-slider-item">
			<img src="img/works/9big-2.jpg" alt="" class="cbp-l-project-img">
		</li>
	</ul>
</div>
...
<div class="cbp-l-project-container" style="max-width: 800px">
	...
	<div class="cbp-l-project-details">
		...
		<ul class="cbp-l-project-details-list">
			...
			<li><strong>Date</strong>22 December 209</li>
	...
	<div class="cbp-l-project-related">
		...
		<ul class="cbp-l-project-related-wrap">
			<li class="cbp-l-project-related-item">
				<a href="ajax/project1.html" class="cbp-singlePage cbp-l-project-related-link">
					<img src="img/works/1.jpg" alt="" width="100%">
					<div class="cbp-l-project-related-title">Dashboard</div>
				</a>
			</li>
			<li class="cbp-l-project-related-item">
				<a href="ajax/project2.html" class="cbp-singlePage cbp-l-project-related-link">
					<img src="img/works/2.jpg" alt="" width="100%">
					<div class="cbp-l-project-related-title">World Clock Widget</div>
				</a>
			</li>
			<li class="cbp-l-project-related-item">
				<a href="ajax/project3.html" class="cbp-singlePage cbp-l-project-related-link">
					<img src="img/works/3.jpg" alt="" width="100%">
