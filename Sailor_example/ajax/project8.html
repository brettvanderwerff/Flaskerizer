...
<div class="cbp-slider" style="max-width: 800px">
	<ul class="cbp-slider-wrap">
		<li class="cbp-slider-item">
			<img src="img/works/8big.jpg" alt="" class="cbp-l-project-img">
		</li>
		<li class="cbp-slider-item">
			<img src="img/works/8big-1.jpg" alt="" class="cbp-l-project-img">
		</li>
		<li class="cbp-slider-item">
			<img src="img/works/8big-2.jpg" alt="" class="cbp-l-project-img">
		</li>
	</ul>
</div>
		...
		<ul class="cbp-l-project-related-wrap">
			...
			<li class="cbp-l-project-related-item">
				<a href="ajax/project10.html" class="cbp-singlePage cbp-l-project-related-link">
					<img src="img/works/10.jpg" alt="" width="100%">
